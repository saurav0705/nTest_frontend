...
var Query = function Query() {
  return __jsx(_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "flex justify-center w-full m-0 md:my-6 bg-green-300 p-4",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    className: "p-2 w-full max-w-sm text-l md:text-2xl",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
    __self: this
  }, "weihfwehfohweofi jknvmvnefovnevndjcjkdsjdscjsdbcjjdscjsdbcj kdjcvjedcnoekmnc jbedvjnefovn nkjbndovnedf"), __jsx("div", {
    className: "px-4 mx-6",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23
...
//# sourceMappingURL=index.js.4d8f51d977f4eaf236c3.hot-update.js.map