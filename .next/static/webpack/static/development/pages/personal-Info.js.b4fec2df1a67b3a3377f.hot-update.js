...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Personal, [{
    ...
    value: function renderQuestions() {
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function renderQuestions$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.state.user);

            case 2:
              console.log('state ----------------- ', this.state.user);
              console.log('questions ------------- ', this.state.user.toString());
              return _context2.abrupt("return", __jsx(react__WEBPACK_IMPORTED_MODULE_6___default.a.Fragment, null));
...
//# sourceMappingURL=personal-Info.js.b4fec2df1a67b3a3377f.hot-update.js.map