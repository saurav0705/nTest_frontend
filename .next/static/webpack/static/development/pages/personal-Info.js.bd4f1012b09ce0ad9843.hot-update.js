...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Personal, [{
    ...
    value: function renderQuestions() {
      console.log(this.state.user.questions);
      return __jsx(react__WEBPACK_IMPORTED_MODULE_6___default.a.Fragment, null, this.state.user.questions.map(function (question) {
        return __jsx("p", {
          className: "text-4l",
          __source: {
...
//# sourceMappingURL=personal-Info.js.bd4f1012b09ce0ad9843.hot-update.js.map